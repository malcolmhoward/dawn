...
- If it's a nitpick, a style opinion beyond what CLAUDE.md specifies, a suggestion to refactor code outside the current changeset, or a "nice to have" future improvement — skip it. Mention it in the table for awareness, but don't touch working code to satisfy a preference.
