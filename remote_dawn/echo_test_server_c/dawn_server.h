...
// === DAWN Audio Protocol Configuration ===
...
// Server Configuration (hardcoded defaults)
...
// === Public API ===
/**
 * Start the DAWN echo server in a separate thread
 * @return DAWN_SUCCESS on success, error code on failure
 */
int dawn_server_start(void);

/**
 * Stop the DAWN echo server and cleanup resources
 */
